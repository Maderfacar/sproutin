  ...
  return (
    <>
      <button
        ...
        className="tappable flex shrink-0 items-center gap-1.5 rounded-full border border-brand-primary bg-brand-wash px-3 py-1.5 text-2xs font-bold text-brand-primary"
      >
