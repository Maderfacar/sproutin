...
import { STUDENT_STATUS_LABEL, useStudentDetail } from '../../../../features/students/adminHooks';
import { RELATION_LABEL } from '../../../../features/people/hooks';
...
//（基本資料 + 家長 + 本月出缺勤 + 最近請假），老師與園長不必在頁面之間跳來跳去。
