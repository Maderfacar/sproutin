...
```text
/liff                     家長＝今天的答案        校方＝今天要做的事（StaffHome，過渡版）
/liff/leave               家長＝申請 + 我的紀錄    校方＝待審核
/liff/attendance          家長＝每天紀錄 + 月統計  老師＝今天這一班的點名
/liff/communication-book  家長＝我小孩那一本      校方＝整班填寫 + 翻閱單一學生
